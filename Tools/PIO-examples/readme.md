...
- [****Drive ten RC-servos****](10-servo-control-using-exec-(GPIO4to13).f) ; PIO driver for 10 RC-servos, pulsewidth from .7ms to 2.5ms. Uses state machine 0 & 1 of PIO0 and the EXEC function on the OUT opcode
