...
- [****SPI-0 driver****](spi-4%20(GPIO26to29)%20125kHz%20&%20cs,%20with%20multiple%20bytes%20data.f) ; Multi byte 125 kHz SPI-0 driver on GPIO26 to GPIO29 with chip select
