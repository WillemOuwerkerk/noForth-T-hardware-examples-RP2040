(* RP2040 hardware I2C, W.O. 16-10-2025

    I2C core:         864 bytes
    with extensions: 1068 bytes
    with examples:   3312 bytes ( PC8574, 24C02 & bus scanner )
...
hex  here
 40048000    value 'I2C      \ I2C1_BASE     I2C register pointer
 0           value SUM       \ Count of bytes to transmit or receive
: I2C-ON        ( -- )
    3 0E gpio!  3 0F gpio!  \ I2C0 on GPIO14 & GPIO15
