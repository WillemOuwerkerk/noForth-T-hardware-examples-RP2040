...
: BLINK     ( -- )                  \ 1 Hz flashing led
    5 dm 17 gpio!                   \ Enable SIO on pin 17
    dm 17 bitmask GPIO-OE **bis     \ Bit is output
    begin
        dm 17 bitmask GPIO-OUT **bix  200 ms \ Toggle LED
    bootkey? until                  \ Until the boot key was pressed
    dm 17 bitmask GPIO-OUT **bic ;  \ LED off

task: BLINKER
: START     ['] blink  blinker start-task  usb-on ;
