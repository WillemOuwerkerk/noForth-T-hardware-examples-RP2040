...
An UF2 image generator will be added as an extra tool for noForth t. This tool runs on win32Forth and uses an Intel-Hex image generator from [this file](../Tools/image.f) or from the noForth t library ( Type: NEED IMAGE ).
